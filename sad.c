...
const int numNotes = 38;                     // number of notes we are playing
int melody[] = {                            // specific notes in the melody
0, 0, NOTE_D4, NOTE_CS4, 
NOTE_B4, NOTE_FS3, NOTE_FS3, NOTE_FS3, NOTE_FS3,NOTE_FS3, NOTE_FS3, NOTE_B4, NOTE_B4, NOTE_B4, NOTE_B4, NOTE_A3, NOTE_B4,
NOTE_G3, NOTE_G3, NOTE_G3, NOTE_G3, NOTE_G3, NOTE_B4, NOTE_B4, NOTE_B4, NOTE_B4, NOTE_B4, NOTE_CS4, NOTE_D4,
NOTE_A3, NOTE_A3, NOTE_A3, NOTE_A3, NOTE_A3, NOTE_A3, NOTE_D4, NOTE_D4, NOTE_D4, NOTE_D4, NOTE_E4,
NOTE_E4, NOTE_CS4};


int noteDurations[] = {     // note durations: 4 = quarter note, 8 = eighth note, etc.:
  4, 4, 8, 8, 16, 16, 16, 16,16,16,16,16,8,16,8,6,16,16,16,16,16,16,16,16,8,16,8,6,16,16,16,16,16,16,16,16,8,16,8,6 };
